  ...
  return (
    <>
      ...
      <section className="section-info">
        ...
        <small>
          <a href="https://terieyenike.github.io/v2" target="_" rel="noopener noreferrer">
            Know more
          </a>
        </small>
        <div className="contact">
          <MailTo email="teyenike1@gmail.com" subject="Let's Talk" body="Hey, teri!" className="mailto">
            {/* <MailIcon className="icon" /> */}
            <EmailIcon className="icon" fontSize="small"/>
            <span>Email</span>
          </MailTo>
          <a href="https://linkedin.com/in/terieyenike" target="_" rel="noopener noreferrer">
            <svg
              className="icon"
              width="16"
              height="16"
